...
import { ArrowBigUpDash, Eye, Pencil } from "lucide-react";
...
import { DocumentLoader } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/documents/components/client/loader";
import { DocumentPreview } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/documents/components/client/preview";
import { MarkdownWriteRule } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/documents/components/client/write-rule";

import { useDocumentNavigation } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/documents/hooks/navigation";
...
const DynamicDocumentWriter = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/documents/components/client/writer"
