...
import { useQueryFileObjects } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/files/api/objects";
...
const DynamicEditFilePreviews = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/files/components/client/previews"
    ),
  {
    ssr: false,
