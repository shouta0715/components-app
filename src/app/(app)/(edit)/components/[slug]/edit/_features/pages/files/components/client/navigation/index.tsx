...
import { AcceptedFiles } from "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/drop-zone/components/client/files-drop-zones";
import { accepts } from "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/drop-zone/utils";
import { DropZoneNavigate } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/files/components/client/navigation/drop-zone";
import { PreviewsNavigate } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/files/components/client/navigation/preview";
import { usePreviewNavigation } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/files/hooks/navigation";
