...
} from "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/loaders";
import { EditSectionTitle } from "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/server/title";
import { useSummaryForm } from "@/app/(app)/(edit)/components/[slug]/edit/_features/pages/summary/hooks";
...
const DynamicCategoryForm = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/categories"
    ),
  {
    ssr: false,
...
const DynamicPreviewDropZone = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/drop-zone/components/client/image-drop-zones"
    ),
  {
    ssr: false,
