...
const DynamicDesktopComponentBreadcrumbs = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/breadcrumbs/desktop"
    ),
  {
    ssr: true,
...
const DynamicMobileComponentBreadcrumbs = dynamic(
  () =>
    import(
      "@/app/(app)/(edit)/components/[slug]/edit/_features/common/components/client/breadcrumbs/mobile"
    ),
  {
    ssr: true,
    loading: () => <Skeleton className="mx-2 h-10 flex-1" />,
