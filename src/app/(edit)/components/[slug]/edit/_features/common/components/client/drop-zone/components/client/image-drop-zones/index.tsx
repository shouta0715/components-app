...
export default function PreviewDropZone({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flex justify-center rounded-lg border border-dashed border-border  pt-10 pb-5 px-4 sm:px-0 transition-colors relative h-96 duration-150 cursor-pointer hover:border-primary hover:border-2",
