...
const DynamicComponentBreadcrumbs = dynamic(
  () =>
    import(
      "@/app/(edit)/components/[slug]/edit/_features/common/components/client/breadcrumbs"
    ),
  {
    ssr: false,
...
export function EditHeader() {
  return (
    <StickyTrigger className="sticky top-0 z-20 -mx-4 -mt-10 border-b border-border bg-background px-2.5 py-2 sm:-mx-6 md:px-4 lg:-mx-8">
